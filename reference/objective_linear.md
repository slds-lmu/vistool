...
Builds a squared-error regression objective with optional elastic net
penalization.
...
- y:
  ...
  ([`numeric()`](https://rdrr.io/r/base/numeric.html)) Numeric responses
...
- loss_scale:
  ...
  (`numeric(1)`) Scaling factor applied to the summed squared errors.
  Defaults to `1 / (2 * sum(weights))`.
...
An
[Objective](https://slds-lmu.github.io/vistool/reference/Objective.md)
instance capturing the squared-error regression risk.

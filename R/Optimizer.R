...
Optimizer = R6::R6Class("Optimizer",
  public = list(
    ...
    initialize = function(objective, x_start, id = NULL, print_trace = TRUE) {
      ...
      private$p_x_start = objective$assert_x(x_start)
    ...
    prepare_update_for_archive = function(x_out, x_in, update, fval_out, fval_in, lr, step_size, objective, step, ...) {
      out = data.table(
        x_out = list(x_out),
        x_in = list(x_in),
        update = list(update),
    ...
    set_x = function(x) {
      private$p_x = private$p_objective$assert_x(x)
    }
  ),
  active = list(
...
OptimizerMomentum = R6::R6Class("OptimizerMomentum",
  ...
  public = list(
    ...
    #' @param step_size_control (`function()`) A function with arguments `x` (the old input value),
    #' `u` (the update generated by `$update()`), `obj` (the objective object), and `opt` the optimizer as `self`.
    ...
    optimize = function(steps = 1L, step_size_control = function(x, u, obj, opt) {
                          return(1)
                        }, minimize = NULL) {
      ...
      for (step in seq_len(steps)) {
        ...
        step_size = step_size_control(super$x, u, super$objective, self)

        if (minimize) u = -u

        x_new = super$x + step_size * u

        lldt = c(lldt, list(super$prepare_update_for_archive(x_new, super$x, u,
      ...
      super$update_archive(do.call(rbind, lldt))
    ...
    update = function(lr, mom) {
      ...
      g = super$objective$eval_store(super$objective$assert_x(super$x))$grad[[1]]
...
OptimizerNAG = R6::R6Class("OptimizerNAG",
  ...
  public = list(
    ...
    #' @template param_steps
    #' @param step_size_control (`function()`) A function with arguments `x` (the old input value),
    #' `u` (the update generated by `$update()`), and `obj` (the objective object).
    #' @param minimize (`logical(1)`) Indicator to whether minimize or optimize the objective. The default (`NULL`)
    #' uses the option defined in `objective$minimize`.
    optimize = function(steps = 1L, step_size_control = function(x, u, obj, opt) {
                          return(1)
      ...
      # checkmate::assertR6(objective, "Objective")
      checkmate::assertCount(steps, positive = TRUE)
      checkmate::assertFunction(step_size_control, args = c("x", "u", "obj"))
      checkmate::assertLogical(minimize, len = 1L, null.ok = TRUE)
      ...
      for (step in seq_len(steps)) {
        ...
        step_size = step_size_control(super$x, u, super$objective)
        ...
        lldt = c(lldt, list(super$prepare_update_for_archive(x_new, super$x, u,
          super$objective$eval_store(x_new)$fval, super$objective$eval(super$x),
    ...
    update = function(lr, mom, minimize) {
      ...
      lookahead = super$objective$assert_x(super$x) + mf * mgo

...
*You can also refer to loss functions via common mlr3 **measure IDs** (e.g., `regr.mse`). These are internally translated internally to the corresponding vistool loss keys.*

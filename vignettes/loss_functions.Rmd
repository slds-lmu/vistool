...
The `VisualizerLossFuns` class visualizes loss functions.
...
vis_scores <- VisualizerLossFuns$new(
...
vis_probs <- VisualizerLossFuns$new(
...
```{r, echo=TRUE, message=FALSE, warning=FALSE, out.width='100%'}
vis_y1 <- VisualizerLossFuns$new(
  list(crossentropy_loss, brier_loss),
  input_type = "probability",
  y_curves = "y0"  # Only show y = 0 curve
)
vis_y1$plot()
```

...
vignette: >
  %\VignetteIndexEntry{Customization Options}
...
## Title and Axis Customization Examples

### Custom Titles and Subtitles
```r
# Override default title and add subtitle
vis$plot(
  plot_title = "Custom Model Performance",
  plot_subtitle = "Trained on dataset XYZ"
)
```
...
```r
# Hide grid lines
vis$plot(show_grid = FALSE)

# Custom grid color
vis$plot(grid_color = "lightblue")
```
...
vis$plot(show_legend = FALSE)

# Position legend at top
vis$plot(legend_position = "top")

# Position legend at bottom with custom title
vis$plot(
  legend_position = "bottom",
  legend_title = "Classification Score"
)
```
...
vis$plot(
  plot_title = "SVM Decision Boundary",
  plot_subtitle = "RBF kernel with C=1.0",
  x_lab = "Feature 1 (standardized)",
  y_lab = "Feature 2 (standardized)", 
  x_limits = c(-3, 3),
  y_limits = c(-3, 3),
  show_grid = TRUE,
  grid_color = "gray95",

...
```{r, out.width='100%', out.height='700px'}
vis$add_training_data(color = c(pos = "red", neg = "blue"), 
                       shape = c(pos = 17, neg = 19))$plot()
```
...
vis_surface$add_training_data(color = c(pos = "red", neg = "blue"),
                              shape = c(pos = 0, neg = 1))$plot()
```

...
```{r, out.width='100%', out.height='700px'}
# Use surface visualizer for interactive plotly visualization
...
Or, with interactive surface visualization:
```{r, out.width='100%', out.height='700px'}
...
- **3D+ objectives**: Currently not supported (would require `VisualizerSurfaceObj` with appropriate extensions)
...
```{r, out.width='100%', out.height='700px'}
# Use surface visualizer for contour layer initialization
